  ...
  return (
    <section id="process" className="section-padding bg-cream-50">
      <div className="container-custom">
              ...
              <div key={index} className="relative">
                <div className="text-center space-y-4">
                  ...
                  <div className="relative inline-flex items-center justify-center">
                    <div className="w-20 h-20 rounded-full bg-cream-50 border-4 border-forest-500 flex items-center justify-center relative z-10 shadow-lg">
        ...
        {/* Bottom CTA */}
        <div className="mt-16 text-center p-8 rounded-2xl bg-gradient-to-br from-forest-50 to-gold-50 border border-forest-100">
          <h3 className="text-2xl font-bold text-cream-900 mb-4">
            Ready to Get Started?
          </h3>
          <p className="text-cream-600 mb-6 max-w-2xl mx-auto">
